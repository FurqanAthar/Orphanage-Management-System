<?php
	...
	if($accountType == 'guardian'){
		$sqlQuery = "SELECT count(*) FROM `guardian_notifications` WHERE `id`='$accountId' and `status`='Unread'";
...
<body>
	...
	<div class="menu">
		...
		<a href="guardCheckNotification.php"><img src="styling/icons/036-calendar.png" class="menuicons"><span>Notifications (<?php echo $notfCount; ?>)</span></a>
